...
/**
 * Background notification scheduler. Runs continuously after the agent has
 * started up. Each kind of nudge has its own throttle so we never spam.
 */
...
const THROTTLES: Record<NotifyKind, number> = {
...
function canFire(kind: NotifyKind): boolean {
