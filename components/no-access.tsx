  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="app-card app-card-lg max-w-md w-full text-center">
        <div className="mx-auto mb-4 w-12 h-12 rounded-full bg-[var(--m-bg-soft)] border border-[var(--m-border)] inline-flex items-center justify-center text-[var(--m-ink-3)]">
        ...
        <p className="mt-2 text-[13px] leading-relaxed text-[var(--m-ink-2)]">{message}</p>
        <Link
          href={backHref}
          prefetch
          className="mt-5 inline-flex items-center justify-center px-4 py-2 rounded-lg bg-[var(--m-ink)] hover:bg-[var(--m-ink-2)] text-white text-[13px] font-medium transition"
        >
          {backLabel}
        </Link>
      </div>
