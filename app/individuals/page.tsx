...
export default async function Home({
  ...
  async function googleSignIn() {
    "use server";
    // /individuals = the solo flow. Mark the visitor as solo so that if they
    // later land on the company landing (/) while signed in, it routes them to
    // their own dashboard rather than org onboarding. Comes back to
    ...
    await signIn("google", { redirectTo: "/individuals" });
  }
  ...
  return (
    <header className="sticky top-0 z-30 backdrop-blur-md bg-[var(--m-bg)]/75 border-b border-[var(--m-border)]/50">
      <div className="max-w-6xl mx-auto px-6 py-3.5 flex items-center justify-between gap-6">
        <a href="/individuals" className="flex items-center gap-2.5">
          <Logo />
        ...
        <nav className="hidden md:flex items-center gap-7 text-[13.5px] text-[var(--m-ink-2)]">
          ...
          <a href="/" className="hover:text-[var(--m-ink)] transition-colors">For companies</a>
        ...
        <div className="lg:col-span-6 min-w-0">
          ...
          <Reveal delay={240}>
            <div id="get-started" className="mt-8 scroll-mt-28">
              <LandingClient authError={sp.auth_error ?? null} googleSignIn={googleSignIn} flow="solo" redirectTo="/individuals" />
            </div>
        ...
        <Reveal>
          ...
          <div className="mt-8 flex flex-col items-center gap-4">
            ...
            <p className="text-[12.5px] text-white/70">
              ...
              <a href="/" className="underline underline-offset-2 hover:text-white">See Marina for teams →</a>
            </p>
          </div>
        </Reveal>
      </div>
    ...
    <footer className="border-t border-[var(--m-border)] bg-[var(--m-bg)]">
      <div className="max-w-6xl mx-auto px-6 py-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
        ...
        <nav className="flex flex-wrap items-center gap-x-6 gap-y-2 text-[13px] text-[var(--m-ink-3)]">
          ...
          <a href="/" className="hover:text-[var(--m-ink)]">For companies</a>
