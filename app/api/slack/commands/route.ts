...
export async function POST(req: Request) {
  ...
  if (!org) {
    return ack(
      `MARINA isn't connected to this Slack workspace yet. An owner can connect it from their MARINA dashboard at ${process.env.NEXT_PUBLIC_APP_URL ?? 'https://marina.team'}.`,
    )
  }
